...
export function createLazyTaskRepository(): TaskRepository {
  return {
    ...
    listListGroups: delegate("listListGroups"),
    createListGroup: delegate("createListGroup"),
    updateListGroup: delegate("updateListGroup"),
    deleteListGroup: delegate("deleteListGroup"),
